                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <form id="formModal" enctype="multipart/form-data" novalidate>
                            <div class="mb-3">
                                <label for="Job" class="form-label">Pilih Type</label>
                                ...
                                <label for="Job" class="form-label">Mahasiswa</label>
                                <div class="input-group mb-3">
                                    <select name="user_id" class="form-select" id="user">
                                        <option selected>Pilih user:</option>
                                    </select>
                                    <input type="text" class="form-control" id="searchUsername" placeholder="Cari User">
                                </div>

                                <label for="Job" class="form-label">Mitra</label>
                                <div class="input-group mb-3">
                                    <select name="mitra_id" class="form-select" id="mitra">
                                        <option selected>Pilih mitra:</option>
                                    </select>
                                    <input type="text" class="form-control" id="searchMitra" placeholder="Cari mitra">
                                </div>
                            </div>
                    </div>
