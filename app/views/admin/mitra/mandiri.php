                    ...
                    <div class="modal-body">
                        <form id="formModal" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" name="mitra" class="form-control mb-3" />

                                <label for="Job" class="form-label">Job:</label>
                                <input type="text" name="job" class="form-control mb-3" />

                                <label for="pic" class="form-label">Pic:</label>
                                <input type="text" name="pic" class="form-control mb-3" />

                                <label for="number" class="form-label">Number Pic:</label>
                                <input type="number" name="number_pic" class="form-control mb-3" />
                            </div>
                    </div>
