...
class InternshipController extends Controller
{
    ...
    public function index()
    {
        $data = [
            'sc' => [
                ...
                // core script
                BASE_URL . 'assets/static/js/pages/mahasiswa_internship.js'
            ],
            'css' => [
        ...
        $this->view('admin/mahasiswa/mahasiswa_internship');
    ...
    public function insert()
    {
        ...
        $status = $this->model('mahasiswa_internship_model')->insert($_POST);
        echo $status;
    }
    ...
    public function destroy()
    {
        ...
        $status = $this->model('mahasiswa_internship_model')->delete($_POST['id']);
        if (is_null($status)) {
    ...
    public function show()
    {
        ...
        $status = $this->model('mahasiswa_internship_model')->getByID($_GET['id']);
    ...
    public function update()
    {
        ...
        $status = $this->model('mahasiswa_internship_model')->update($_POST);
        echo $status;
    }
    ...
    public function fetch()
    {
        ...
        $data = $this->model('mahasiswa_internship_model')->show();
    ...
    public function user()
    {
        ...
        $data = $this->model('mahasiswa_internship_model')->getUser($_GET["username"]);
    ...
    public function penelitian()
    {
        ...
        $data = $this->model('mahasiswa_internship_model')->getMitraOnPenelitian($_GET["title"]);
    ...
    public function partnership()
    {
        ...
        $data = $this->model('mahasiswa_internship_model')->getMitraOnPartnership($_GET["title"]);
