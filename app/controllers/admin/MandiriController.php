...
class MandiriController extends Controller
{
    ...
    public function index()
    {
        $data = [
            'sc' => [
                ...
                // core script
                BASE_URL . 'assets/static/js/pages/mandiri.js'
            ],
            'css' => [
    ...
    public function insert()
    {
        ...
        $status = $this->model('mandiri_model')->insert($_POST);
        echo $status;
    }
    ...
    public function destroy()
    {
        ...
        $status = $this->model('mandiri_model')->delete($_POST['id']);
        if (is_null($status)) {
    ...
    public function show()
    {
        ...
        $status = $this->model('mandiri_model')->getByID($_GET['id']);
    ...
    public function update()
    {
        ...
        $status = $this->model('mandiri_model')->update($_POST, $_FILES);
        echo $status;
    }
    ...
    public function fetch()
    {
        ...
        $data = $this->model('mandiri_model')->show();
    ...
    public function user()
    {
        ...
        $data = $this->model('mandiri_model')->getUser($_GET["username"]);
