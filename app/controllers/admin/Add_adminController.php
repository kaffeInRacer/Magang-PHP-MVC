...
class Add_adminController extends Controller
{
    ...
    public function index()
    {
        $data = [
            'sc' => [
                ...
                // core script
                BASE_URL . 'assets/static/js/pages/add_admin.js'
            ],
            'css' => [
        ...
        $this->view('admin/admin/add_admin');
    ...
    public function insert()
    {
        ...
        $status = $this->model('admin_model')->insert($_POST, $_FILES);
        echo $status;
    }
    ...
    public function destroy()
    {
        ...
        $status = $this->model('admin_model')->delete($_POST['id']);
        if (is_null($status)) {
    ...
    public function show()
    {
        ...
        $status = $this->model('admin_model')->getByID($_GET['id']);
    ...
    public function update()
    {
        ...
        $status = $this->model('admin_model')->update($_POST, $_FILES);
        echo $status;
    }
    ...
    public function fetch()
    {
        ...
        $data = $this->model('admin_model')->show();
