...
class PartnershipController extends Controller
{
    ...
    public function index()
    {
        $data = [
            'sc' => [
                ...
                BASE_URL . 'assets/extensions/ckeditor/ckeditor.js',
                BASE_URL . 'assets/main.js',
                // core script
                BASE_URL . 'assets/static/js/pages/partnership.js'
            ],
            'css' => [
        ...
        $this->view('admin/mitra/partnership');
    ...
    public function insert()
    {
        ...
        $status = $this->model('partnership_model')->insert($_POST, $_FILES);
    ...
    public function destroy()
    {
        ...
        $status = $this->model('partnership_model')->delete($_POST['id']);
        if (is_null($status)) {
    ...
    public function show()
    {
        ...
        $status = $this->model('partnership_model')->getByID($_GET['id']);
    ...
    public function update()
    {
        ...
        $status = $this->model('partnership_model')->update($_POST, $_FILES);
        echo $status;
    }
    ...
    public function fetch()
    {
        ...
        $data = $this->model('partnership_model')->show();
