...
class PenelitianController extends Controller
{
    ...
    public function index()
    {
        $data = [
            'sc' => [
                ...
                // core script
                BASE_URL . 'assets/static/js/pages/penelitian.js'
            ],
            'css' => [
        ...
        $this->view('admin/mitra/penelitian');
    ...
    public function insert()
    {
        ...
        $status = $this->model('penelitian_model')->insert($_POST, $_FILES);
    ...
    public function destroy()
    {
        ...
        $status = $this->model('penelitian_model')->delete($_POST['id']);
        if (is_null($status)) {
    ...
    public function show()
    {
        ...
        $status = $this->model('penelitian_model')->getByID($_GET['id']);
    ...
    public function update()
    {
        ...
        $status = $this->model('penelitian_model')->update($_POST, $_FILES);
        echo $status;
    }
    ...
    public function fetch()
    {
        ...
        $data = $this->model('penelitian_model')->show();
