...
class admin_model
{
    ...
    {
        $query = "INSERT INTO $this->table (username, password, email, telp, gender, role, image) 
                  VALUES (:username, :password, :email, :telp, :gender, :role, :image)";
        $this->db->query($query);
    ...
    {
        $query = "SELECT username, email, telp, gender, role, image FROM $this->table WHERE id = :id";
        $this->db->query($query);
        $this->db->bind(':id', $id);
    ...
    {
        $query = "SELECT id,username, email, telp, gender, role, image FROM $this->table WHERE role = 'admin'";
        $this->db->query($query);
